...
async function handleOdometerReply(
  ...
  // docs/PRD.md §5.4/§5.5: a new reading re-evaluates due status and fires
  // the first service_due push for anything newly due.
  await evaluateAndNotifyDueServices(supabase, vehicle.id);

...
3. Fonts are project-supplied (Arabic: Noto Sans Arabic; English: per `docs/design.md`) — do not choose or add any. Icons: use the **Lucide** icon library exclusively — do not mix in another icon set.
